...
3. Forking [kcd-scripts](https://github.com/kentcdodds/kcd-scripts) or similar and adapt to their needs
...
Since `ugo-run postinstall` should be configured as the `postinstall` npm script, all the configs that were marked to be saved will be automatically created when you install a project with `$ npm install`.
